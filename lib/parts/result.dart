...
Map<String, dynamic> _$ResultArgumentToJson(ResultArguments? instance) {
  ...
  if (instance != null) {
    ...
    if (instance.beautifulPlaceCount != null) {
      params['beautifulPlaceCount'] ??= {};
      if (instance.beautifulPlaceCount != null &&
          instance.beautifulPlaceCount != '') {
        params['beautifulPlaceCount'] = instance.beautifulPlaceCount;
      } else {
        params['beautifulPlaceCount'] = [];
      }
    }
    if (instance.reference != null) {
      params['reference'] ??= {};
      if (instance.reference != null && instance.reference != '') {
        params['reference'] = instance.reference;
      } else {
        params['reference'] = [];
      }
    }
