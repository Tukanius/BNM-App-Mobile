...
class Choibalsanstatue extends StatefulWidget {
  const Choibalsanstatue({super.key});

  @override
  State<Choibalsanstatue> createState() => _ChoibalsanstatueState();
}

class _ChoibalsanstatueState extends State<Choibalsanstatue> {
  List<String> TopImage = [
    "http://159.223.56.204:8000/asset/add/choibalsan/choibalsan-1-2.jpg",
    "http://159.223.56.204:8000/asset/add/choibalsan/choibalsan-2-2.jpg",
    "http://159.223.56.204:8000/asset/add/choibalsan/choibalsan-3-2.jpg",
  ];
  @override
                ...
                children: [
                  Row(
                    ...
                    children: [
                      ...
                      GestureDetector(
                        onTap: () async {
                          double latitude = 47.92296;
                          double longitude = 106.91930;
