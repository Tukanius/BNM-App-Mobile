...
class Sukhbaatarstatue extends StatefulWidget {
  const Sukhbaatarstatue({super.key});

  @override
  State<Sukhbaatarstatue> createState() => _SukhbaatarstatueState();
}

class _SukhbaatarstatueState extends State<Sukhbaatarstatue> {
  List<String> TopImage = [
    "http://159.223.56.204:8000/asset/add/sukhbaatarStatue/suhbaatar-1.jpg",
    "http://159.223.56.204:8000/asset/add/sukhbaatarStatue/suhbaatar-2.jpg",
    "http://159.223.56.204:8000/asset/add/sukhbaatarStatue/suhbaatar-3.jpg",
    "http://159.223.56.204:8000/asset/add/sukhbaatarStatue/suhbaatar-4.jpg",
  ];
  @override
