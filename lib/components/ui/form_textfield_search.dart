...
class FormTextfieldSearch extends StatefulWidget {
  final String name;
  ...
  @override
  FormTextfieldSearchState createState() => FormTextfieldSearchState();
}

class FormTextfieldSearchState extends State<FormTextfieldSearch> {
